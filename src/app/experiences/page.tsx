...
export default function ExperiencesPage() {
  ...
  return (
    <PublicLayout>
      ...
      <section className="bg-[#FDFAF7] py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <SectionHeader
              ...
              >
                ...
                <div className="flex flex-col flex-1 p-6 gap-4">
                  <div>
                    ...
                    <h3
                      className="font-serif text-xl font-normal text-[#2A2421] leading-snug mb-3"
            ...
            <div className="flex flex-col gap-0 divide-y divide-[#D7C6B2]">
              {processSteps.map((step) => (
                <div key={step.number} className="flex gap-6 py-8 first:pt-0 last:pb-0">
                  <span
                    className="font-serif text-4xl font-normal text-[#D7C6B2] leading-none flex-shrink-0 w-12"
