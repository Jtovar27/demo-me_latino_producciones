...
export interface Database {
  public: {
    ...
    Tables: {
      ...
      real_happiness_hosts: {
        Row: RealHappinessHostRow;
        Insert: Partial<RealHappinessHostRow>;
        Update: Partial<RealHappinessHostRow>;
        Relationships: [];
      };
    };
  };
...
export type DBRealHappinessHost    = RealHappinessHostRow;
